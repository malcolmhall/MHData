...
@interface MHDStackManager : NSObject

// Singleton access
+ (instancetype)sharedManager;

/// Managed object model for the application, defaults to mhd_defaultModel
@property (nonatomic, strong) NSManagedObjectModel *managedObjectModel;

/// Primary persistent store coordinator for the application, defaults to mhd_coordinatorWithManagedObjectModel
@property (nonatomic, strong) NSPersistentStoreCoordinator *persistentStoreCoordinator;

/// URL for the Core Data store file, defaults to mhd_defaultStoreURLWithError
