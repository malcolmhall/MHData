...
#import "MCDNSPersistentContainer.h"
...
- (instancetype)initWithName:(NSString *)name managedObjectModel:(NSManagedObjectModel *)model
{
    ...
    if (self) {
        ...
        _persistentStoreDescriptions = @[[MCDNSPersistentStoreDescription persistentStoreDescriptionWithURL:URL]];
    }
    return self;
}
...
- (void)loadPersistentStoresWithCompletionHandler:(void (^)(MCDNSPersistentStoreDescription *, NSError * _Nullable))block{
    for(MCDNSPersistentStoreDescription *sd in _persistentStoreDescriptions){
        [_persistentStoreCoordinator mcd_addPersistentStoreWithDescription:sd completionHandler:block];
    }
}
